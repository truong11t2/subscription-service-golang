...
func (app *Config) PostLoginPage(w http.ResponseWriter, r *http.Request) {
	...
	app.Session.Put(r.Context(), "flash", "Login successfully!")
...
func (app *Config) PostRegisterPage(w http.ResponseWriter, r *http.Request) {
	...
	app.sendEmail(msg)
	app.Session.Put(r.Context(), "flash", "Sent confirmation email. Please check your email.")
	http.Redirect(w, r, "/login", http.StatusSeeOther)
...
func (app *Config) ActivateAccount(w http.ResponseWriter, r *http.Request) {
	...
	app.Session.Put(r.Context(), "flash", "Activated account. You can now login.")
	http.Redirect(w, r, "/login", http.StatusSeeOther)
}
...
func (app *Config) SubcribeToPlan(w http.ResponseWriter, r *http.Request) {
	...
	// generate a manual and send email
	app.Wait.Add(1)
	go func() {
		defer app.Wait.Done()
